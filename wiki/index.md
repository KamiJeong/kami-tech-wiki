...
- [OpenUI 실시간 개인화 화면 사례 검토](ko/openui/personalization-case-reference.md) — OpenUI 가능성과 실시간 개인화 화면 공개 사례를 근거 상태별로 비교 (updated: 2026-05-28, sources: 0)
...
- [OpenUI Real-Time Personalization Case Reference](en/openui/personalization-case-reference.md) — Evidence-labeled comparison of OpenUI feasibility and public personalization examples (updated: 2026-05-28, sources: 0)
...
- [OpenUI リアルタイムパーソナライズ事例リファレンス](ja/openui/personalization-case-reference.md) — OpenUI の実現可能性と公開パーソナライズ事例を根拠ステータス別に比較 (updated: 2026-05-28, sources: 0)
