...
compatibility: "Requires Spec Kit skills and .claude/agents/speckit-*.md definitions"
metadata:
...
See `.claude/skills/speckit-rules/SKILL.md` for the full stage sequence, agent mapping, and mode rules.
